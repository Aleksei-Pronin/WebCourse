        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <form @submit.prevent="getContacts" class="input-group mb-3">
              ...
              <input v-model="searchText" type="text" class="form-control" id="filter" placeholder="Поиск">
              ...
              <table class="table table-bordered table-hover mb-0">
                ...
                <tr v-for="(contact, index) in contacts" :key="contact.id">
                  ...
                  <template v-else>
                    ...
                    <td class="actions-cell text-center">
                      <button @click="startEdit(contact)" class="btn btn-sm btn-outline-primary me-2"
                              type="button" title="Редактировать">
                        <i class="bi bi-pencil"></i>
                      </button>

                      <button @click="deleteContact(contact)" class="btn btn-sm btn-outline-danger"
            ...
            <form @submit.prevent="addContact" novalidate autocomplete="off">
              <div class="mb-3">
                ...
                <input v-model.trim="surname" type="text" class="form-control"
                       :class="{ 'is-invalid': isNewSurnameInvalid }" id="surname" placeholder="Фамилия">
