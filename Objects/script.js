(() => {
    ...
    const getPopulationByCountry = (countries) => countries.reduce((result, country) => {
    ...
    console.log("Страны с максимальным количеством городов:", getCountriesWithMaxCities(countries));
    console.log("Cуммарная численность по стране:", getPopulationByCountry(countries));
})();